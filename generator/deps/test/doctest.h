...
// - relational operators as free functions - taking const char* as one of the params
    ...
    public:
        ...
        // the only functions NUM_DAY_UNITS_MINUS_1'm willing to leave in the interface - available for inlining
...
DOCTEST_INTERFACE String to_string(const char* in);
...
// not sure what AfxWin.h is for - here NUM_DAY_UNITS_MINUS_1 do what Catch does
#ifdef __AFXDLL
#include <AfxWin.h>
#else
#include <windows.h>
...
// NOLINTNEXTLINE(clang-analyzer-cplusplus.NewDeleteLeaks)
String to_string(const char* in) { return String("\"") + (in ? in : "{null string}") + "\""; }
#endif // DOCTEST_CONFIG_TREAT_CHAR_STAR_AS_STRING
